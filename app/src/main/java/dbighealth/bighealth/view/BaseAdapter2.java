 ...
 */
public class BaseAdapter2<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {

    public Context context;//上下文
    public List<CommonHomeBean.ResultBean> listDatas;//数据源
    ...
    public BaseAdapter2(Context context, List<CommonHomeBean.ResultBean> listDatas) {
     ...
     */
    public BaseAdapter2(Context context, List<CommonHomeBean.ResultBean> listDatas, OnViewClickListener onViewClickListener) {
        init(context,listDatas);
     ...
     * @param listDatas
     */
    void init(Context context, List<CommonHomeBean.ResultBean> listDatas){
