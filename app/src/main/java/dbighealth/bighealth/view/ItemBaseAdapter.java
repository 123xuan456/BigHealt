 ...
 */
public class ItemBaseAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {

    public Context context;//上下文
    public List<CommonHealth.ItemListBean> listDatas;//数据源
    ...
    public ItemBaseAdapter(Context context, List<CommonHealth.ItemListBean> listDatas) {
     ...
     */
    public ItemBaseAdapter(Context context, List<CommonHealth.ItemListBean> listDatas, OnViewClickListener onViewClickListener) {
        init(context,listDatas);
     ...
     * @param listDatas
     */
    void init(Context context, List<CommonHealth.ItemListBean> listDatas){
