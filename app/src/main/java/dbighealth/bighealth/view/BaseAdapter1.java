 ...
 */
public class BaseAdapter1<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {

    public Context context;//上下文
    public List<CommonHomeBean.ResultBean.ResultsBean> listDatas;//数据源
    ...
    public BaseAdapter1(Context context, List<CommonHomeBean.ResultBean.ResultsBean> listDatas) {
     ...
     */
    public BaseAdapter1(Context context, List<CommonHomeBean.ResultBean.ResultsBean> listDatas, OnViewClickListener onViewClickListener) {
        init(context,listDatas);
     ...
     * @param listDatas
     */
    void init(Context context, List<CommonHomeBean.ResultBean.ResultsBean> listDatas){
